							...
							<li id="form_prop_advanced_option" class="clear advanced_prop form_prop">
								...
								<fieldset>
								  ...
								  <div style="padding-bottom: 10px">
										 ...
										 <img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="You can register your own custom javascript file to run inline with the form. Your script will be loaded each time the form is being displayed."/>
								  </div>
