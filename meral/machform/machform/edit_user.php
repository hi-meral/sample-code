						...
						<li>
							<div id="au_box_user_profile" class="au_box_main gradient_blue">
								...
								<div class="au_box_content" style="padding-bottom: 15px">
									...
									<label class="choice" for="au_tsv_enable">Enable 2-Step Verification </label><img class="helpmsg" src="images/icons/68_blue.png" style="vertical-align: top" title="2-Step Verification is an optional but highly recommended security feature that adds an extra layer of protection to MachForm account.<br/><br/>Once enabled, MachForm will require a six-digit security code in addition to the standard password whenever a user sign-in."/>
								</div>
							</div>
						</li>
