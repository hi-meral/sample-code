 ...
 ********************************************************************************/
	...
	function mf_set_language($target_language){
		...
		if($target_language == 'english'){
			...
			//form resume
			$languages['resume_email_subject']		= 'Entri data anda ke %s telah disimpan sebagian.';
			$languages['resume_email_content'] 		= 'Terima kasih! Entri data anda ke <b>%s</b> telah disimpan sebagian.<br /><br />Anda dapat melanjutkan lagi di lain waktu dengan menggunakan link dibawah ini:<br /><a href="%s">%s</a><br /><br /><br /><br /><b>PENTING:</b><br />Data anda baru akan tersimpan sepenuhnya setelah anda melanjutkan entri data dan menekan tombol Kirim.';							
			...
			$languages['file_attach']		  		= 'Pilih File';
