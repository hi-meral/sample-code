						...
						<li>
							<div id="ms_box_user_tsv" class="ms_box_main gradient_red">
								<div class="ms_box_title">
									...
									<label for="tsv_enable" class="choice">Enable 2-Step Verification</label>
									<img class="helpmsg" src="images/icons/68_red.png" style="vertical-align: top" title="2-Step Verification is an optional but highly recommended security feature that adds an extra layer of protection to your MachForm account.<br/><br/>Once enabled, MachForm will require a six-digit security code in addition to your password whenever you sign in."/>
								</div>
