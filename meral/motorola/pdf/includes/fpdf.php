...
function FPDF($orientation='P',$unit='mm',$format='A4')
{
	...
	if(is_string($format))
	{
		...
		/*if((isset($_REQUEST['tblwidth']) && $_REQUEST['tblwidth'] != '') && (isset($_REQUEST['tblheight']) && $_REQUEST['tblheight'] != ''))	$format=array($_REQUEST['tblwidth'],$_REQUEST['tblheight']);		
		elseif($format=='a1')	$format=array(12000,12000);
		else*/
		if($format=='a3')	$format=array(1141.89,1490.55);
