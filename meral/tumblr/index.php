...
if($_REQUEST["sub1"]=="post")
{
    ?>
    
    <h1>Thanks you. <br> Share your data to Tumblr</h1>
    <?php
    ozh_yourls_tumblr(array($_REQUEST["url"],$_REQUEST["url"],$_REQUEST["title"],$_REQUEST["text"]));    
}
else{
   ozh_yourls_tumblr(array()); 
...
function ozh_yourls_tumblr( $args ) {
        ...
        <a id="share_tb"
                ...
                onclick="yourls_share_on_tumblr();return false;">&nbsp;&nbsp;&nbsp;&nbsp;
        </a>
