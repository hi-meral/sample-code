		...
		var fieldAdd = function() {
			...
			$('.new-element').click(function(){
				...
				dust.render(tpl, data, function(err, out) {
					...
					currentlySelected.attr("style",'clear:both;');
		...
		*/
		var controlSettings = function() {
			...
			$('#control-add-field').click(function(){
				...
				clearSelectedElements();
				currentlySelected.prepend("<div style='clear:both;'></div>");
			});	
			
			$('#control-add-column').click(function(){
					//var temp = currentlySelected;
					//currentlySelected.remove();
					//currentlySelected.html(' ');
					
					var Nextid = currentlySelected.attr("style","width:38%; float:left;").attr('id');
					var split_next_id = Nextid.split('-');
					//alert(currentlySelected.attr('id'));
					currentlySelected.append("<div style='clear:both;'></div>");
					$('#element-'+(++split_next_id[1])).attr("style","width:38%; float:left;")
					$('#element-'+(++split_next_id[1])).attr("style","clear:both;")
					//currentlySelected.html(' ');
			});	
