...
/*  Created On : 22-Dec-2016 7:48:01 PM 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
DROP TABLE IF EXISTS `gn_email_assn_settings` CASCADE
;

DROP TABLE IF EXISTS `gn_email_assn_template` CASCADE
;

DROP TABLE IF EXISTS `gn_email_context` CASCADE
;

DROP TABLE IF EXISTS `gn_email_instance` CASCADE
;

DROP TABLE IF EXISTS `gn_email_status` CASCADE
;

DROP TABLE IF EXISTS `gn_email_template` CASCADE
;

DROP TABLE IF EXISTS `gn_email_variable` CASCADE
;

DROP TABLE IF EXISTS `gn_email_variable_value` CASCADE
;
...
DROP TABLE IF EXISTS `gn_global_settings` CASCADE
;
...
DROP TABLE IF EXISTS `gn_hide_profile_info` CASCADE
;
...
DROP TABLE IF EXISTS `gn_merch_pmt_transaction` CASCADE
;

DROP TABLE IF EXISTS `gn_merch_trans_result` CASCADE
;

DROP TABLE IF EXISTS `gn_merch_trans_type` CASCADE
;
...
DROP TABLE IF EXISTS `gn_sub_fee_trans_type` CASCADE
;
...
(
	...
	`junior_fee` DECIMAL(10,2) NOT NULL,
...
(
	...
	`hide_profile_info_cd` CHAR(20) NOT NULL,
...
CREATE TABLE `gn_email_assn_settings`
(
	`association_id` INT NOT NULL,
	`email_api_key` VARCHAR(50) NOT NULL,
	`from_name` VARCHAR(200) NOT NULL,
	`from_email_address` VARCHAR(50) NOT NULL,
	`reply_to_email_address` VARCHAR(50) NOT NULL,
	`tracks_opens` BOOL NOT NULL,
	`tracks_clicks` BOOL NOT NULL,
	CONSTRAINT `PK_gn_email_assn_settings` PRIMARY KEY (`association_id` ASC)
)
ENGINE=InnoDB

;

CREATE TABLE `gn_email_assn_template`
(
	...
	CONSTRAINT `PK_EmailAssnTemplate` PRIMARY KEY (`email_template_cd` ASC, `association_id` ASC)
)
ENGINE=InnoDB

;

CREATE TABLE `gn_email_context`
(
	`email_context_cd` CHAR(20) NOT NULL,
	`email_context_name` VARCHAR(200) NOT NULL,
	`context_db_entity` VARCHAR(200) NOT NULL,
	CONSTRAINT `PK_EmailTemplate` PRIMARY KEY (`email_context_cd` ASC)
)
ENGINE=InnoDB

;

CREATE TABLE `gn_email_instance`
(
	`email_instance_id` INT NOT NULL AUTO_INCREMENT,
	`association_id` INT NOT NULL,
	`email_template_cd` CHAR(20) NOT NULL,
	`context_id` INT NOT NULL,
	`email_subject` VARCHAR(1000) NOT NULL,
	`email_body` TEXT NULL,
	`email_status_cd` CHAR(20) NOT NULL,
	`status_datetime` DATETIME NOT NULL,
	`priority` INT NOT NULL,
	`from_email_address` VARCHAR(200) NOT NULL,
	`to_email_addresses` VARCHAR(1000) NOT NULL,
	`cc_email_addresses` VARCHAR(1000) NULL,
	CONSTRAINT `PK_gn_email` PRIMARY KEY (`email_instance_id` ASC)
)
ENGINE=InnoDB

;

CREATE TABLE `gn_email_status`
(
	`email_status_cd` CHAR(20) NOT NULL,
	`email_status_value` VARCHAR(200) NOT NULL,
	CONSTRAINT `PK_gn_email_status` PRIMARY KEY (`email_status_cd` ASC)
)
ENGINE=InnoDB
...
(
	`email_template_cd` CHAR(20) NOT NULL,
	`email_context_cd` VARCHAR(20) NOT NULL,
	`email_subject` VARCHAR(1000) NOT NULL,
	`email_body` TEXT NULL,
	`is_enabled` BOOL NOT NULL,
	CONSTRAINT `PK_EmailTemplate` PRIMARY KEY (`email_template_cd` ASC)
)
ENGINE=InnoDB

;

CREATE TABLE `gn_email_variable`
(
	`email_variable_id` INT NOT NULL AUTO_INCREMENT,
	`email_context_cd` CHAR(20) NOT NULL,
	`replacement_token` VARCHAR(50) NOT NULL,
	`variable_description` VARCHAR(200) NULL,
	`resolution_path` VARCHAR(200) NOT NULL,
	CONSTRAINT `PK_EmailTemplate` PRIMARY KEY (`email_variable_id` ASC)
)
ENGINE=InnoDB

;

CREATE TABLE `gn_email_variable_value`
(
	`email_instance_id` INT NOT NULL,
	`email_variable_id` INT NOT NULL,
	`variable_value` VARCHAR(2000) NOT NULL,
	CONSTRAINT `PK_gn_email_variable_value` PRIMARY KEY (`email_instance_id` ASC, `email_variable_id` ASC)
)
ENGINE=InnoDB
...
CREATE TABLE `gn_global_settings`
(
	`global_settings_id` INT NOT NULL,
	`gn_system_version` CHAR(10) NOT NULL,
	`php_timezone` VARCHAR(50) NOT NULL,
	`test_day_offset` INT NOT NULL,
	`testing_allowed` BOOL NOT NULL,
	CONSTRAINT `PK_gn_global_settings` PRIMARY KEY (`global_settings_id` ASC)
)
ENGINE=InnoDB
...
CREATE TABLE `gn_hide_profile_info`
(
	`hide_profile_info_cd` CHAR(20) NOT NULL,
	`hide_profile_info_value` VARCHAR(100) NOT NULL,
	CONSTRAINT `PK_gn_hide_profile_setting` PRIMARY KEY (`hide_profile_info_cd` ASC)
)
ENGINE=InnoDB
...
(
	...
	`participate_in_ojr` BOOL NOT NULL DEFAULT 0,
	`display_in_widget` BOOL NOT NULL DEFAULT 0,
...
CREATE TABLE `gn_merch_pmt_transaction`
(
	`merchant_payment_id` INT NOT NULL,
	`transaction_sequence` INT NOT NULL,
	`merch_trans_type_cd` CHAR(20) NOT NULL,
	`transaction_amount` DECIMAL(10,2) NOT NULL,
	`transaction_token` VARCHAR(50) NOT NULL,
	`transaction_datetime` DATETIME NOT NULL,
	`merch_trans_result_cd` CHAR(20) NOT NULL,
	`transaction_message` VARCHAR(1000) NULL,
	`auth_code` VARCHAR(100) NULL,
	`response_code` VARCHAR(100) NULL,
	CONSTRAINT `PK_gn_merch_payment_action` PRIMARY KEY (`transaction_sequence` ASC, `merchant_payment_id` ASC)
)
ENGINE=InnoDB

;

CREATE TABLE `gn_merch_trans_result`
(
	`merch_trans_result_cd` CHAR(20) NOT NULL,
	`merch_trans_result_value` VARCHAR(100) NOT NULL,
	CONSTRAINT `PK_gn_merch_action_result` PRIMARY KEY (`merch_trans_result_cd` ASC)
)
ENGINE=InnoDB

;

CREATE TABLE `gn_merch_trans_type`
(
	`merch_trans_type_cd` CHAR(20) NOT NULL,
	`merch_trans_type_value` VARCHAR(100) NOT NULL,
	CONSTRAINT `PK_gn_merch_action_type` PRIMARY KEY (`merch_trans_type_cd` ASC)
)
ENGINE=InnoDB
...
(
	...
	`payment_identifier` VARCHAR(50) NULL,
	`payment_description` VARCHAR(1000) NULL,
	`payment_field_data` VARCHAR(2000) NULL,
	`last_trans_sequence` INT NOT NULL,
...
CREATE TABLE `gn_sub_fee_trans_type`
(
	`subscription_fee_id` INT NOT NULL,
	`transaction_type_cd` CHAR(20) NOT NULL,
	CONSTRAINT `PK_gn_sub_fee_trans_type` PRIMARY KEY (`subscription_fee_id` ASC, `transaction_type_cd` ASC)
)
ENGINE=InnoDB
...
(
	...
	`renewal_merch_id` VARCHAR(50) NULL,
...
(
	...
	`restrict_by_trans_type` BOOL NOT NULL DEFAULT 0,
...
(
	...
	`assn_merchant_fee` DECIMAL(10,2) NULL,
	`club_merchant_fee` DECIMAL(10,2) NULL,
...
ALTER TABLE `gn_email_assn_template` 
 ADD INDEX `IXFK_email_assn_template_association` (`association_id` ASC)
;
...
ALTER TABLE `gn_association_settings` 
 ADD CONSTRAINT `FK_gn_association_settings_gn_hide_profile_info`
	FOREIGN KEY (`hide_profile_info_cd`) REFERENCES `gn_hide_profile_info` (`hide_profile_info_cd`) ON DELETE Restrict ON UPDATE Restrict
;
...
ALTER TABLE `gn_email_assn_settings` 
 ADD CONSTRAINT `FK_gn_email_assn_settings_gn_association`
	FOREIGN KEY (`association_id`) REFERENCES `gn_association` (`association_id`) ON DELETE Restrict ON UPDATE Restrict
;
...
ALTER TABLE `gn_email_assn_template` 
 ADD CONSTRAINT `FK_email_assn_template_email_template`
	FOREIGN KEY (`email_template_cd`) REFERENCES  () ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `gn_email_instance` 
 ADD CONSTRAINT `FK_gn_email_instance_gn_association`
	FOREIGN KEY (`association_id`) REFERENCES `gn_association` (`association_id`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `gn_email_instance` 
 ADD CONSTRAINT `FK_gn_email_instance_gn_email_status`
	FOREIGN KEY (`email_status_cd`) REFERENCES `gn_email_status` (`email_status_cd`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `gn_email_instance` 
 ADD CONSTRAINT `FK_gn_email_instance_gn_email_template`
	FOREIGN KEY (`email_template_cd`) REFERENCES `gn_email_template` (`email_template_cd`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `gn_email_template` 
 ADD CONSTRAINT `FK_gn_email_template_gn_email_context`
	FOREIGN KEY (`email_context_cd`) REFERENCES `gn_email_context` (`email_context_cd`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `gn_email_variable` 
 ADD CONSTRAINT `FK_gn_email_variable_gn_email_context`
	FOREIGN KEY (`email_context_cd`) REFERENCES `gn_email_context` (`email_context_cd`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `gn_email_variable_value` 
 ADD CONSTRAINT `FK_gn_email_variable_value_gn_email_instance`
	FOREIGN KEY (`email_instance_id`) REFERENCES `gn_email_instance` (`email_instance_id`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `gn_email_variable_value` 
 ADD CONSTRAINT `FK_gn_email_variable_value_gn_email_variable`
	FOREIGN KEY (`email_variable_id`) REFERENCES `gn_email_variable` (`email_variable_id`) ON DELETE Restrict ON UPDATE Restrict
;
...
ALTER TABLE `gn_merch_pmt_transaction` 
 ADD CONSTRAINT `FK_gn_merch_pmt_transaction_gn_merch_trans_result_cd`
	FOREIGN KEY (`merch_trans_result_cd`) REFERENCES `gn_merch_trans_result` (`merch_trans_result_cd`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `gn_merch_pmt_transaction` 
 ADD CONSTRAINT `FK_gn_merch_pmt_transaction_gn_merch_trans_type_cd`
	FOREIGN KEY (`merch_trans_type_cd`) REFERENCES `gn_merch_trans_type` (`merch_trans_type_cd`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `gn_merch_pmt_transaction` 
 ADD CONSTRAINT `FK_gn_merch_pmt_transaction_gn_merchant_payment`
...
ALTER TABLE `gn_sub_fee_trans_type` 
 ADD CONSTRAINT `FK_gn_sub_fee_trans_type_gn_subscription_fee`
	FOREIGN KEY (`subscription_fee_id`) REFERENCES `gn_subscription_fee` (`subscription_fee_id`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `gn_sub_fee_trans_type` 
 ADD CONSTRAINT `FK_gn_sub_fee_trans_type_gn_transaction_type`
	FOREIGN KEY (`transaction_type_cd`) REFERENCES `gn_transaction_type` (`transaction_type_cd`) ON DELETE Restrict ON UPDATE Restrict
;
